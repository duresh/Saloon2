...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2026 at 06:51 AM
...
(1, 4, 1, 2, '2026-05-24', '12:00:00', 'confirmed', '', '2026-05-24 03:50:28', '2026-05-24 03:53:22', 0, NULL),
(2, 4, 2, 1, '2026-05-24', '09:30:00', 'confirmed', '', '2026-05-24 03:50:44', '2026-05-24 04:11:00', 0, NULL),
(3, 4, 3, 2, '2026-05-30', '12:00:00', 'confirmed', '', '2026-05-24 03:51:09', '2026-05-24 03:53:01', 0, NULL),
(4, 4, 7, 2, '2026-05-24', '13:00:00', 'confirmed', '', '2026-05-24 03:51:39', '2026-05-24 03:53:16', 0, NULL);
...
INSERT INTO `user_profiles` (`id`, `user_id`, `profile_image`, `address`, `bio`, `notification_email`, `notification_sms`, `created_at`, `updated_at`) VALUES
(1, 4, NULL, NULL, NULL, 1, 0, '2026-05-24 03:51:51', NULL);
...
--
ALTER TABLE `customer_notifications`
  ADD CONSTRAINT `customer_notifications_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `reg` (`regID`) ON DELETE CASCADE,
  ADD CONSTRAINT `customer_notifications_ibfk_2` FOREIGN KEY (`appointment_id`) REFERENCES `appointments` (`id`) ON DELETE SET NULL;
